    ...
    <div class="">
        ...
        <header class="u-header u-header--error-page">
            ...
            <router-link :to="{ name: 'dashboard' }" class="u-header-logo">
                <img class="u-header-logo__icon" src="/assets/backend/svg/logo-mini.svg" alt="500">
                <img class="u-header-logo__text ml-1" src="/assets/backend/svg/logo-text-dark.svg" alt="500" width="140">
            </router-link>
            <!-- End Header Logo -->
        </header>
        <!-- End Header (Topbar) -->
        ...
        <main class="u-error-content-wrap">
            <div class="u-error-content container text-center my-auto">
                ...
                <h2 class="u-error__sub-title">Internal server error</h2>
                ...
                <figure class="u-shape u-shape-top-left">
                    <img src="/assets/backend/svg/shapes/shape-1.svg" alt="500">
                </figure>
                <figure class="u-shape u-shape-top-right">
                    <img src="/assets/backend/svg/shapes/shape-2.svg" alt="500">
                </figure>
                <figure class="u-shape u-shape-bottom-left">
                    <img src="/assets/backend/svg/shapes/shape-3.svg" alt="500">
                </figure>
                <figure class="u-shape u-shape-bottom-right">
                    <img src="/assets/backend/svg/shapes/shape-4.svg" alt="500">
                </figure>
                <!-- End SVG Shapes -->
