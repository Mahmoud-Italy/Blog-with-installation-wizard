        ...
        <main class="u-main">
            ...
            <div class="u-content">
                <div class="u-body min-h-700">
                    <h1 class="h2 mb-2 text-capitalize">Categories
    ...
    export default {
        ...
        methods: {
            ...
            fetchData(page_url, loading=false) {
                ...
                page_url = page_url || '/api/v1/dashboard/categories';
